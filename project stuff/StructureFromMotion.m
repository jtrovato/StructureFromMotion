...
if report
    %3D
    figure(4);
    visualizeStructure(Xlintri, {}, {}, repmat([1 0 0], length(Xlintri), 1));
    hold on;
    visualizeStructure(X, {}, {}, repmat([0 0 1], length(X), 1));
    hold off;
...
figure(8)
visualizeStructure(X, Cr_set, Rr_set, colors(idx(ptmask),:));
hold on;
pause(0.025);
